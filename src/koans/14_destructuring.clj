...
(meditations
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
     (let [[first-name last-name & aliases]
       ...
       (str first-name " " last-name (apply str (interleave (take (count aliases) (repeat " aka ")) aliases)))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     (#(str (first %1) " " (second %1) ", " (:street-address %2) ", " (:city %2) ", " (:state %2)) ["Test" "Testerson"] test-address)))
